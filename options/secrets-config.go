...
func securityProxySetTLSCertificate(tlsCertificate, tlsPrivateKey, tlsSNIs string) error {
	...
	args := []string{"proxy", "tls",
		"--inCert", tlsCertFilename,
		"--inKey", tlsPrivateKeyFilename,
		"--targetFolder", env.SnapData + "/nginx"}
	...
	// TODO: add a hash to snap options instead of semaphore file?
