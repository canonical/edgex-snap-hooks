...
var ConfToEnv = map[string]string{
	...
	"core-data/messagequeue.topic": "MESSAGEQUEUE_TOPIC",
	...
	// [Binding]
	"app/binding.type":            "BINDING_TYPE",
	"app/binding.subscribe-topic": "BINDING_SUBSCRIBE_TOPIC",
	"app/binding.publish-topic":   "BINDING_PUBLISH_TOPIC",

	// [MessageBus.SubscribeHost]
	"app/message-bus.subscribe-host.port": "MESSAGEBUS_SUBSCRIBEHOST_PORT",

	// [MessageBus.PublishHost]
	"app/message-bus.publish-host.port": "MESSAGEBUS_PUBLISHHOST_PORT",

	// [Smtp]
	"support-notifications/smtp.host":                    "SMTP_HOST",
	"support-notifications/smtp.username":                "SMTP_USERNAME",
	"support-notifications/smtp.password":                "SMTP_PASSWORD",
	"support-notifications/smtp.port":                    "SMTP_PORT",
	"support-notifications/smtp.sender":                  "SMTP_SENDER",
	"support-notifications/smtp.enable-self-signed-cert": "SMTP_ENABLE_SELF_SIGNED_CERT",
	...
	// TODO: validation
	//
	"security-proxy/add-proxy-route": "ADD_PROXY_ROUTE",

	// [KongAuth]
	"security-proxy/kongauth.name": "KONGAUTH_NAME",
	...
	// TODO: validation
	//
	"security-secret-store/add-secretstore-tokens": "ADD_SECRETSTORE_TOKENS",
}
